...
class ContinuousTimeGaussianDiffusion(nn.Module):
    def __init__(
        ...
        *,
        ...
        learned_noise_schedule_frac_gradient=1.0,  # between 0 and 1, determines what percentage of gradients go back, so one can update the learned noise schedule more slowly
        p2_loss_weight_gamma=0.0,  # p2 loss weight, from https://arxiv.org/abs/2204.00227 - 0 is equivalent to weight of 1 across time
        p2_loss_weight_k=1,
    ):
        super().__init__()
